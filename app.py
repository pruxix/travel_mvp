...
КРИТИЧЕСКИ ВАЖНО: пиши маршрут ПОЛНОСТЬЮ, не останавливайся на середине, доведи до конца все разделы. Цены пищи в рублях, отталкиваясь от курса, что доллар = 100 рублей.
